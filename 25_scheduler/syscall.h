...
static inline int      sys_setpriority(int prio)                         { return syscall(SYS_SETPRIORITY, prio, 0, 0); }
static inline int      sys_getpriority(void)                             { return syscall(SYS_GETPRIORITY, 0, 0, 0); }
