...
#define SYS_IOCTL         24
#define SYS_SELECT        25   /* select(nfds, readfds_bits) -> ready bits */
#define SYS_STAT          26   /* fstat(fd, struct stat*) -> 0 or -err     */
#define SYS_LSEEK         27   /* lseek(fd, offset, whence) -> new offset  */
